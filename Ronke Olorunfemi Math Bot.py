...
def equation():
	...
	#checking out the two solutions. 
	...
	while trig is False and status is False:
		try:
			...
			if trigonometry == 1:
				trig1 =True
				#calculating sine
				sine_value = float(input("Enter a value: "))
				print()
				answer = math.sin(sine_value)
				print(f"Your sine result is {answer}")
				status = True
				...
				trig2 = True
				cos_value = float(input("Enter a value: "))
				print()
				answer = math.cos(cos_value)
				print(f"Your cos result is {answer}")
				status = True
				print("_ "*27) 
				...
				#calc of Tan
				trig3 = True
				tan_value = float(input("Enter a value: "))
				print()
				
				answer = math.tan(tan_value)
				print(f"Your tan result is {answer}")
				status = True
				print("_ "*27) 
				...
				answer = math.asin(arcsine_value)
				...
				print()
				answer = math.acos(arc_cos_value)
				...
				print()
				answer = math.atan(arc_tan_value)
				...
				print()
				answer = math.degrees(degrees_value)
				print()
				
				
				print(f"Your degrees result is {answer}")
				...
				print()
				answer = math.radians(radians_value)
				print()
